...
class AppState:
    def __init__(self):
        ...
        self.output_dir = "/content/ComfyUI/output"
        self.useQ6 = False
    ...
    try:
        ...
        if not os.path.exists("/content/ComfyUI"):
            ...
            subprocess.run(["git", "clone", "https://github.com/Isi-dev/ComfyUI",
                          "/content/ComfyUI"], check=True, capture_output=True)
    ...
    try:
        ...
        if not os.path.exists(model_path):
            ...
            subprocess.run(["aria2c", "--console-log-level=error", "-c", "-x", "16",
                          "-s", "16", "-k", "1M", model_url,
                          "-d", "/content/ComfyUI/models/unet", "-o", model_name],
                          check=True)
...
def generate_video(
    ...
    try:
        ...
        with torch.inference_mode():
            ...
            progress(0.5, desc="Generating video (this may take a while)...")
...
def create_interface():
    ...
    with gr.Blocks(
        ...
        title="Betelmatrix -AI Video Generator",
        css="""
        .gradio-container {
        ...
        gr.Markdown("""
        # 🎬 Betelmatrix : AI video Generator
        ...
        with gr.Tabs() as tabs:
            ...
            with gr.Tab("1️⃣ Environment Setup", id=0):
                ...
                setup_btn.click(
                    ...
                    fn=lambda: gr.update(value="✅ Environment setup complete!"),
            ...
            with gr.Tab("2️⃣ Download Models", id=1):
                ...
                with gr.Row():
                    use_q6_checkbox = gr.Checkbox(
                        label="Use Q6 Model (Higher quality, requires more VRAM)",
                        value=False
                    )
